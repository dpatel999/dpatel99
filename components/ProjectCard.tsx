        ...
        <div className="relative overflow-hidden h-full rounded-2xl transition duration-200 group bg-gray-200 hover:shadow-xl border-2 border-zinc-100">
          ...
          <div className="p-4">
            ...
            <div className="flex flex-row justify-between items-center mt-10">
              <span className="text-sm text-gray-500">{data.workDone}</span>
            ...
            <ModalBody>
              ...
              <ScrollShadow className="h-[300px] md:h-full">
                <div className="text-sm">
                  <p className="text-justify">{data.projectDesc}</p>
                  ...
                  <div>
                    <ul className="space-y-4">
                      <li className="grid grid-cols-3">
                        ...
                        <span className="col-span-2">{data.association}</span>
                      </li>
                      <li className="grid grid-cols-3">
                        <span className="text-gray-500 dark:text-gray-400">
                          Preview:
                      ...
                      <li className="grid grid-cols-3">
                        ...
                        <span className="col-span-2">
                          {data.techstack.split(",").map((x) => (
                            <Chip key={x} size="sm" className="m-1">
                              {x}
                            </Chip>
                          ))}
                        </span>
